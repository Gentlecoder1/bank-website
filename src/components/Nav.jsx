...
const Nav = () => {
    ...
    const burgerStyle = "md:hidden mx-5 -mt-6 p-4 ease-in-out duration-500 rounded-2xl text-white bg-[#1D1C1D] shadow-md shadow-orange-200 items-center"
  ...
  return (
    <header className='sticky xl:w-[1280px] z-10 mx-auto flex flex-col'>
        ...
        <div className={`transition-all duration-900 overflow-hidden ${!burger ? "max-h-0 opacity-0" : `max-h-96  flex flex-col items-center opacity-100 ${burgerStyle}`}`}>
