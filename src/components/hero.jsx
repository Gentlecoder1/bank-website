  ...
  return (
    <div className='w-full flex mx-auto justify-center relative my-7'>
        ...
        >
          ...
          <div className="text-center md:text-left xl:w-[55%] lg:w-[58%] md:w-[65%] md:absolute md:left-4 md:mt-6 lg:mt-0 lg:top-6 lg:left-6 md:z-20 md:p-8 lg:p-14 p-6 bg-[#191919] rounded-3xl md:rounded-tr-none md:rounded-bl-none relative -mb-10 md:-mb-0 -top-12 md:-top-0 z-10" data-aos="fade-up">
            <p className='md:text-[16px] text-[14px] font-[500] text-white'>{props.greet}</p>
            <h1 className="text-white text-[28px] md:text-[38px] font-bold mb-4">
