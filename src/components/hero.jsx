  ...
  return (
    <div className='w-full flex mx-auto justify-center relative my-7'>
        ...
        <div 
          ...
          className='md:w-full bg-[#1D1C1D] border-[1px] border-gray-400 md:rounded-2xl rounded-3xl p-8 md:p-7 lg:p-12 flex flex-col-reverse md:relative items-center md:items-start'
        >

          <div className="text-center md:text-left xl:w-[55%] lg:w-[58%] md:w-[65%] md:absolute md:left-8 md:mt-6 lg:mt-0 lg:top-12 lg:left-12 md:z-20 md:p-8 lg:p-14 p-6 bg-[#191919] rounded-3xl md:rounded-tr-none md:rounded-bl-none relative -mb-10 md:-mb-0 -top-12 md:-top-0 z-10" data-aos="fade-up">
